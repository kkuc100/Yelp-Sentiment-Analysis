...
class Trainer:
    ...
    def _validate_epoch(self, epoch):
        ...
        with torch.no_grad():
            for i, (
                ...
                self._append_validation_records(features, labels, out, epoch)
    ...
    def _append_validation_records(self, features, labels, out, epoch):
    ...
    def _save_config(self):
        self.logger.info(f"Config: {str(self.config)}")
